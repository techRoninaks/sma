<?php
    ...
    $data = array('prodId'=>$prodId,'createdDate'=>$createDate2,'createDate'=>$mdate,'orderIdShort'=>$orderIdShort,'orderId'=>$orderId,'gift_note'=>$row2['gift_note'],'gift_address'=>$row2['gift_address'],'gift_title'=>$row2['gift_title'],
