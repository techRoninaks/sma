<?php
    ...
    $sql_pr_view = "SELECT SUM(p.product_view_count) as prod_view FROM smapr.product p, smausr.shop_details sl WHERE p.shop_id = sl.id and sl.seller_id = '$sellerId'";
    ...
    $sql_activ = "SELECT COUNT(*) AS active_prod FROM smapr.product p, smausr.shop_details sl WHERE p.shop_id = sl.id and sl.seller_id = '$sellerId' and p.active_status = 'active'";
