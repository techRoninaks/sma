<?php
    ...
    $sql_query7 = "SELECT count(*) as Ordercount FROM `purchase_order` where sellerid = $sellerId && order_status = 'pending confirmation' ";
    $result7 = mysqli_query($con2, $sql_query7);
    $row7 = mysqli_fetch_array($result7);
    $orderCount=$row7["Ordercount"];
    
    $sql="SELECT `orderid` FROM `purchase_order` WHERE sellerid = $sellerId && order_status = 'pending confirmation' ORDER BY `orderid` ASC";
