<?php
require dirname("./invoice-generator/invoicr-11/invoicr.php");
$invoice = new Invoicr();
...
$invoice->set("company", [
    ...
    "cb-logo.png",
    "../src/assets/invoice-generator/invoicr-11/" . DIRECTORY_SEPARATOR . "cb-logo.png", 
    "Code Boxx", 
...
$invoice->outputHTML(3, "../src/assets/invoice-generator/invoicr-11/" . DIRECTORY_SEPARATOR . "invoice.html");
...
$invoice->outputPDF(3, "../src/assets/invoice-generator/invoicr-11/" . DIRECTORY_SEPARATOR . "invoice.pdf");

// 3D - DOCX OUTPUT
// DEFAULT FORCE DOWNLOAD| 1 FORCE DOWNLOAD | 2 SAVE ON SERVER
$invoice->outputDOCX();
$invoice->outputDOCX(1, "invoice.docx");
$invoice->outputDOCX(2, "../src/assets/invoice-generator/invoicr-11/" . DIRECTORY_SEPARATOR . "invoice.docx");
